...
yarn workspace @corona-dashboard/cms lokalize:export --dataset=development --clean-json
else
yarn workspace @corona-dashboard/cms lokalize:export --dataset=production --clean-json
fi
