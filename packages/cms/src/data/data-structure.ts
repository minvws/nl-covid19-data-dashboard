...
export const dataStructure = {
  gm: {
    ...
    hospital_nice: ['admissions_on_date_of_admission', 'admissions_on_date_of_admission_moving_average', 'admissions_on_date_of_admission_moving_average_rounded', 'admissions_on_date_of_reporting'],
    ...
    vaccine_coverage_per_age_group: ['age_group_range', 'fully_vaccinated_percentage', 'booster_shot_percentage', 'has_one_shot_percentage', 'birthyear_range', 'fully_vaccinated_percentage_label', 'booster_shot_percentage_label', 'has_one_shot_percentage_label'],
    vaccine_coverage_per_age_group_archived: ['age_group_range', 'fully_vaccinated_percentage', 'has_one_shot_percentage', 'birthyear_range', 'fully_vaccinated_percentage_label', 'has_one_shot_percentage_label'],
  ...
  nl: {
    booster_shot_administered: ['administered_total', 'ggd_administered_total', 'others_administered_total'],
    ...
    intensive_care_nice: ['admissions_on_date_of_admission', 'admissions_on_date_of_admission_moving_average', 'admissions_on_date_of_admission_moving_average_rounded', 'admissions_on_date_of_reporting'],
    intensive_care_nice_per_age_group: ['admissions_age_0_19_per_million', 'admissions_age_20_29_per_million', 'admissions_age_30_39_per_million', 'admissions_age_40_49_per_million', 'admissions_age_50_59_per_million', 'admissions_age_60_69_per_million', 'admissions_age_70_79_per_million', 'admissions_age_80_89_per_million', 'admissions_age_90_plus_per_million', 'admissions_overall_per_million'],
    tested_overall: ['infected', 'infected_moving_average', 'infected_moving_average_rounded', 'infected_per_100k', 'infected_per_100k_moving_average'],
    tested_per_age_group: ['infected_age_0_9_per_100k', 'infected_age_10_19_per_100k', 'infected_age_20_29_per_100k', 'infected_age_30_39_per_100k', 'infected_age_40_49_per_100k', 'infected_age_50_59_per_100k', 'infected_age_60_69_per_100k', 'infected_age_70_79_per_100k', 'infected_age_80_89_per_100k', 'infected_age_90_plus_per_100k', 'infected_overall_per_100k'],
    ...
    tested_ggd: ['infected', 'infected_moving_average', 'infected_percentage', 'infected_percentage_moving_average', 'tested_total', 'tested_total_moving_average', 'tested_total_moving_average_rounded'],
    tested_ggd_archived: ['infected_percentage', 'infected_percentage_moving_average'],
    nursing_home: ['newly_infected_people', 'newly_infected_people_moving_average', 'deceased_daily', 'deceased_daily_moving_average', 'newly_infected_locations', 'infected_locations_total', 'infected_locations_percentage'],
    disability_care: ['newly_infected_people', 'newly_infected_people_moving_average', 'deceased_daily', 'deceased_daily_moving_average', 'newly_infected_locations', 'infected_locations_total', 'infected_locations_percentage'],
    behavior: [
    ...
    vaccine_coverage_per_age_group: ['age_group_range', 'age_group_percentage', 'age_group_total', 'fully_vaccinated', 'booster_shot', 'has_one_shot', 'fully_vaccinated_percentage', 'booster_shot_percentage', 'has_one_shot_percentage', 'date_of_report_unix', 'birthyear_range'],
    vaccine_coverage_per_age_group_archived: ['age_group_range', 'age_group_percentage', 'age_group_total', 'fully_vaccinated', 'has_one_shot', 'fully_vaccinated_percentage', 'has_one_shot_percentage', 'date_of_report_unix', 'birthyear_range'],
    vaccine_coverage_per_age_group_estimated: ['age_18_plus_fully_vaccinated', 'age_18_plus_has_one_shot', 'age_18_plus_birthyear', 'age_12_plus_fully_vaccinated', 'age_12_plus_has_one_shot', 'age_12_plus_birthyear'],
    vaccine_stock: ['total_available', 'total_not_available', 'bio_n_tech_pfizer_available', 'bio_n_tech_pfizer_not_available', 'bio_n_tech_pfizer_total', 'moderna_available', 'moderna_not_available', 'moderna_total', 'astra_zeneca_available', 'astra_zeneca_not_available', 'astra_zeneca_total', 'janssen_available', 'janssen_not_available', 'janssen_total'],
  ...
  vr: {
    ...
    tested_ggd: ['infected', 'infected_moving_average', 'infected_percentage', 'infected_percentage_moving_average', 'tested_total', 'tested_total_moving_average', 'tested_total_moving_average_rounded'],
    tested_ggd_archived: ['infected_percentage', 'infected_percentage_moving_average'],
    nursing_home: ['newly_infected_people', 'newly_infected_people_moving_average', 'newly_infected_locations', 'infected_locations_total', 'infected_locations_percentage', 'deceased_daily', 'deceased_daily_moving_average'],
    disability_care: ['newly_infected_people', 'newly_infected_people_moving_average', 'newly_infected_locations', 'infected_locations_total', 'infected_locations_percentage', 'deceased_daily', 'deceased_daily_moving_average'],
    behavior: [
      'number_of_participants',
      'curfew_compliance',
      'curfew_compliance_trend',
    ...
    situations: ['has_sufficient_data', 'situations_known_percentage', 'situations_known_total', 'investigations_total', 'home_and_visits', 'work', 'school_and_day_care', 'health_care', 'gathering', 'travel', 'hospitality', 'other'],
    vaccine_coverage_per_age_group: ['age_group_range', 'fully_vaccinated_percentage', 'booster_shot_percentage', 'has_one_shot_percentage', 'birthyear_range', 'fully_vaccinated_percentage_label', 'booster_shot_percentage_label', 'has_one_shot_percentage_label'],
    vaccine_coverage_per_age_group_archived: ['age_group_range', 'fully_vaccinated_percentage', 'has_one_shot_percentage', 'birthyear_range', 'fully_vaccinated_percentage_label', 'has_one_shot_percentage_label'],
    booster_coverage: ['age_group', 'percentage', 'percentage_label'],
  },
