...
context('Landelijk - Positief geteste mensen', () => {
  ...
  it('Should show the correct KPI values', function (this: NlContext) {
    const infectedTotalLastValue = getLastFilledValue(this.nationalData.tested_overall_archived_20230417);
    const ggdLastValue = getLastFilledValue(this.nationalData.tested_ggd_archived_20230417);
