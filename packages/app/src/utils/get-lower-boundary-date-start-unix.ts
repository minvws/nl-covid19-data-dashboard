 ...
 * range of values.
 */
export function getLowerBoundaryDateStartUnix(values: TimestampedValue[], numberOfItems: number): number {
  ...
  return isDateValue(boundaryValue) ? boundaryValue.date_unix : boundaryValue.date_start_unix;
}
