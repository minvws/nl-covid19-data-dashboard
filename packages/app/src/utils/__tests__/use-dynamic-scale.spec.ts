...
UseDynamicScale('should return the given min and max when value falls somewhere between', () => {
...
UseDynamicScale('should return the given a stretched max when value is greater than max', () => {
 ...
 */
UseDynamicScale.skip('should return the given a stretched min when value is less than min', () => {
