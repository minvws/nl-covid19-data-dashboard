 ...
 */
export function getThresholdValue(thresholdValues: ChoroplethThresholdsValue[], filterBelow: number) {
  const filteredValues = thresholdValues.filter((item: ChoroplethThresholdsValue) => {
