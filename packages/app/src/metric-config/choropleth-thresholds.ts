import { ChoroplethThresholdsValue } from './common';
import {
  BehaviorIdentifier,
  behaviorIdentifiers,
...
export const positiveTestedThresholds: ChoroplethThresholdsValue[] = [
  {
...
export const hospitalAdmissionsThresholds: ChoroplethThresholdsValue[] = [
  {
    color: colors.data.underReported,
    threshold: 0,
  },
...
export const elderlyAtHomeThresholds: ChoroplethThresholdsValue[] = [
  {
    color: colors.data.underReported,
    threshold: 0,
  },
...
export const sewerThresholds: ChoroplethThresholdsValue[] = [
  {
    color: colors.data.underReported,
    threshold: 0,
  },
...
export const vrHospitalAdmissionsThresholds: ChoroplethThresholdsValue[] = [
  {
    color: colors.data.underReported,
    threshold: 0,
  },
...
export const escalationThresholds: ChoroplethThresholdsValue<1 | 2 | 3 | 4>[] =
  [
    {
...
export const infectedLocationsPercentageThresholds: ChoroplethThresholdsValue[] =
  [
    {
      color: colors.data.underReported,
      threshold: 0,
...
export const behaviorComplianceThresholds: ChoroplethThresholdsValue[] = [
  {
    color: colors.data.scale.blue[0],
    threshold: 0,
  },
...
export const behaviorSupportThresholds: ChoroplethThresholdsValue[] = [
  {
...
export const vaccineCoverageThresholds: ChoroplethThresholdsValue[] = [
  {
    color: colors.data.scale.blue[0],
    threshold: 0,
    label: '',
...
export const situationsThreshold: ChoroplethThresholdsValue[] = [
  {
...
export const hasSufficientDataThresholds = [
  {
    color: colors.silver,
    threshold: 0,
  },
