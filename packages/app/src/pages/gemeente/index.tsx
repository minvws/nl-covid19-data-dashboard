import { colors, ArchivedGmCollectionHospitalNice, gmData } from '@corona-dashboard/common';
...
const Municipality = (props: StaticProps<typeof getStaticProps>) => {
  ...
  const data = useMemo(() => {
    return gmData.map<ArchivedGmCollectionHospitalNice>(
      (x) =>
        ({
          gmcode: x.gemcode,
          admissions_on_date_of_reporting: null,
        } as unknown as ArchivedGmCollectionHospitalNice)
    );
  }, []);
