    ...
    <>
      <Head>
        ...
        {/* <meta
          ...
          content="default-src 'self' statistiek.rijksoverheid.nl 5mog5ask.apicdn.sanity.io;
            connect-src 'self' 5mog5ask.apicdn.sanity.io;
            script-src 'self' statistiek.rijksoverheid.nl;
