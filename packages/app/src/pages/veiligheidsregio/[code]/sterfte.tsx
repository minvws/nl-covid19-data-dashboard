...
import { ChartTile, KpiTile, KpiValue, Markdown, PageInformationBlock, TileList, TimeSeriesChart, TwoKpiSection } from '~/components';
...
export const getStaticProps = createGetStaticProps(
  ...
  selectVrData('deceased_cbs', 'deceased_rivm', 'difference.deceased_rivm__covid_daily'),
      ...
      <VrLayout vrName={vrName}>
        <TileList>
          ...
          <TwoKpiSection>
            ...
            >
              <KpiValue data-cy="covid_daily" absolute={dataRivm.last_value.covid_daily} difference={difference.deceased_rivm__covid_daily} isAmount />
