...
export const getStaticProps = createGetStaticProps(
  ...
  selectNlData('difference.corona_melder_app_warning__count', 'corona_melder_app_warning_archived_20220420', 'corona_melder_app_download_archived_20220420')
);
...
const CoronamelderPage = (props: StaticProps<typeof getStaticProps>) => {
  ...
  const warningLastValue = data.corona_melder_app_warning_archived_20220420.last_value;
        ...
        <TileList>
            ...
            >
              ...
              <Text>
                {replaceComponentsInText(corona_melder_app.waarschuwingen.total, {
                  totalDownloads: <BoldText color="primary">{formatNumber(data.corona_melder_app_download_archived_20220420.last_value.count)}</BoldText>,
                })}
              </Text>
            </KpiTile>
          ...
          >
            <TimeSeriesChart
              ...
              values={data.corona_melder_app_warning_archived_20220420.values}
              endDate={endDate}
              seriesConfig={[
                {
                  type: 'area',
