...
export const getStaticProps = createGetStaticProps(
  ...
  selectNlData('difference.doctor__covid_symptoms_per_100k', 'difference.doctor__covid_symptoms', 'doctor_archived_20220823')
);

const SuspectedPatients = (props: StaticProps<typeof getStaticProps>) => {
  const { pageText, selectedNlData: data, lastGenerated } = props;
  const lastValue = data.doctor_archived_20220823.last_value;
        ...
        <TileList>
          ...
          <ChartTile title={text.linechart_titel} metadata={{ source: text.bronnen.nivel }} description={text.linechart_description}>
            <TimeSeriesChart
              ...
              values={data.doctor_archived_20220823.values}
              seriesConfig={[
                {
                  type: 'area',
