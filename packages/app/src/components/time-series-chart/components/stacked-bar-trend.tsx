...
import { Bounds, GetX, GetY0, GetY1, SeriesDoubleValue } from '../logic';
...
export function StackedBarTrend({ series, fillOpacity = DEFAULT_FILL_OPACITY, color, getX, getY0, getY1, bounds, bandPadding = 0.2, id, yScale, seriesMax }: BarTrendProps) {
  ...
  const outOfBoundsItems: SeriesDoubleValue[] = [];
