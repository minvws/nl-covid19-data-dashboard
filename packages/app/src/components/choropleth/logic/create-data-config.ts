...
import { DEFAULT_HOVER_STROKE_WIDTH, DEFAULT_STROKE_WIDTH } from './use-feature-props';
 ...
 * @returns
 */
export function createDataConfig<T extends ChoroplethDataItem>(partialDataConfig: OptionalDataConfig<T>) {
  ...
  return {
    ...
    hoverStrokeWidth: partialDataConfig.hoverStrokeWidth ?? DEFAULT_HOVER_STROKE_WIDTH,
    highlightStroke: partialDataConfig.highlightStroke ?? colors.white,
    highlightStrokeWidth: partialDataConfig.highlightStrokeWidth ?? DEFAULT_HOVER_STROKE_WIDTH,
