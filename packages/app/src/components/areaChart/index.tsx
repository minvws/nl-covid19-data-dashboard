...
export default function AreaChart(props: AreaChartProps) {
  ...
  const { siteText, formatNumber, formatDateFromMilliseconds } = useIntl();
  ...
  const chartOptions = useMemo(() => {
    function getChartOptions(props: IGetOptions): Highcharts.Options {
      ...
      const options: Highcharts.Options = {
            ...
            ? [
                {
                  ...
                  label: {
                    text: siteText.common.barScale.signaalwaarde,
                    align: 'right',
                    y: -8,
                    x: 0,
                    style: {
        ...
        tooltip: {
          ...
          xDateFormat: '%d %b %y',
          formatter() {
            const rangePoint = rangeData.find(
    ...
    timeframe,
    lineData,
    siteText.common.barScale.signaalwaarde,
