        ...
        >
          <defs>
            <clipPath id={`${id}-cut-off`}>
              <rect x="0" y={36} rx="2" ry="2" width={`${scale(value)}%`} height="10" fill="black" />
            </clipPath>
          ...
          <g>
            <rect x="0" y={36} rx="2" ry="2" width="100%" height="10" clipPath={`url(#${id}-cut-off)`} fill={`url(#${id}-bar-color)`} />
            <rect x="0" y={42} rx="2" ry="2" width="100%" height="4" fill={`url(#${id}-bar-color)`} />
          </g>
