...
CreateGetStaticProps('Returns a merged object when multiple promises are passed', async () => {
...
CreateGetStaticProps('Return an object containing an error when a system error is thrown', async () => {
  const fn1 = () =>
    sinon.promise(() => {
