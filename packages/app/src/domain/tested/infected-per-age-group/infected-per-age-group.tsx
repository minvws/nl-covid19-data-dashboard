import { NlTestedPerAgeGroupArchived_20230417Value, TimeframeOption } from '@corona-dashboard/common';
...
export function InfectedPerAgeGroup({ values, timeframe, accessibility, timelineEvents, text }: InfectedPerAgeGroup) {
  ...
  const seriesConfig: LineSeriesDefinition<NlTestedPerAgeGroupArchived_20230417Value>[] = BASE_SERIES_CONFIG.map((baseAgeGroup) => {
