...
export function NlLayout(props: NlLayoutProps) {
  ...
  const items = useSidebar({
    layout: 'nl',
    map: [
      ['development_of_the_virus', ['sewage_measurement', 'reproduction_number', 'variants', 'mortality']],
      ['consequences_for_healthcare', ['hospitals_and_care', 'patients', 'nursing_home_care']],
      ['actions_to_take', ['vaccinations', 'compliance']],
      [
        'archived_metrics',
        ['positive_tests', 'disabled_care', 'elderly_at_home', 'source_investigation', 'coronamelder_app', 'infectious_people', 'general_practitioner_suspicions'],
      ],
    ],
  });
