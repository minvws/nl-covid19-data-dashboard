...
export function NlLayout(props: NlLayoutProps) {
  ...
  const items = useSidebar({
    ...
    map: [
      ...
      ['consequences_for_healthcare', ['hospital_admissions', 'intensive_care_admissions', 'nursing_home_care', 'disabled_care', 'elderly_at_home']],
      ['actions_to_take', ['vaccinations', 'current_advices', 'compliance']],
      ['archived_metrics', ['source_investigation', 'coronamelder_app', 'infectious_people', 'general_practitioner_suspicions']],
    ],
  });
