import { ArchivedGmVaccineCoveragePerAgeGroupWithBoosterShotValue, NlVaccineCoveragePerAgeGroupArchived_20220908Value } from '@corona-dashboard/common';
...
interface BoosterCoveragePerAgeGroupProps {
  ...
  sortingOrder: string[];
  values: NlVaccineCoveragePerAgeGroupArchived_20220908Value[] | ArchivedGmVaccineCoveragePerAgeGroupWithBoosterShotValue[];
