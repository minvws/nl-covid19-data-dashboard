import { assert, colors, DateValue, NlVaccineCoverage, NlVaccineCoverageValue } from '@corona-dashboard/common';
...
type DailyNlVaccineCoverageValue = Omit<NlVaccineCoverageValue, 'date_start_unix' | 'date_end_unix'> & DateValue;
