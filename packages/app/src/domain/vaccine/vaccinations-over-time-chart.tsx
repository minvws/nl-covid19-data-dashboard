import { assert, colors, DateValue, NlVaccineCoverageArchived_20220518, NlVaccineCoverageArchived_20220518Value } from '@corona-dashboard/common';
...
interface VaccinationsOverTimeChartProps {
  coverageData?: NlVaccineCoverageArchived_20220518;
...
type DailyNlVaccineCoverageValue = Omit<NlVaccineCoverageArchived_20220518Value, 'date_start_unix' | 'date_end_unix'> & DateValue;

function transformToDayTimestamps(values: NlVaccineCoverageArchived_20220518Value[]) {
