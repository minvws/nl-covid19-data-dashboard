import { NlVaccineAdministered, NlVaccineAdministeredValue } from '@corona-dashboard/common';
import { omit } from 'lodash';

export type VaccineAdministrationsValue = Omit<NlVaccineAdministeredValue, 'date_start_unix' | 'date_end_unix'> & {
  date_unix: number;
};
...
export function selectAdministrationData(vaccineAdministered: NlVaccineAdministered) {
