import { ArchivedGmVaccineCoveragePerAgeGroupValue, NlVaccineCoveragePerAgeGroupArchivedValue } from '@corona-dashboard/common';
...
interface VaccineCoveragePerAgeGroupProps {
  ...
  sortingOrder: string[];
  values: NlVaccineCoveragePerAgeGroupArchivedValue[] | ArchivedGmVaccineCoveragePerAgeGroupValue[];
