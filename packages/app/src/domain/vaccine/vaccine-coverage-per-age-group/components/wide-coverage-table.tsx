      ...
      <StyledTable>
        ...
        >
          <Row>
            ...
            >
              <InlineText variant="label1">{text.archived.vaccination_coverage.headers.first_shot}</InlineText>
            </HeaderCell>
            <HeaderCell
              css={css({
                textAlign: 'right',
            ...
            >
              <InlineText variant="label1">{text.archived.vaccination_coverage.headers.coverage}</InlineText>
            </HeaderCell>
            <HeaderCell
              css={css({
                width: asResponsiveArray({
            ...
            >
              <InlineText variant="label1">{text.archived.vaccination_coverage.headers.difference}</InlineText>
            </HeaderCell>
          </Row>
        </thead>
        <tbody>
