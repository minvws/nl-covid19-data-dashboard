...
export type CoverageKindProperty = 'autumn_2022_vaccinated_percentage' | 'fully_vaccinated_percentage';

const COVERAGE_KINDS: CoverageKindProperty[] = ['autumn_2022_vaccinated_percentage', 'fully_vaccinated_percentage'];
