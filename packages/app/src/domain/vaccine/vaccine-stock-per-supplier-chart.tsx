import { colors, getValuesInTimeframe, NlVaccineStockArchived_20211027Value, TimeframeOption } from '@corona-dashboard/common';
...
interface VaccineStockPerSupplierChartProps {
  values: NlVaccineStockArchived_20211027Value[];
...
export function VaccineStockPerSupplierChart({ values, text }: VaccineStockPerSupplierChartProps) {
  ...
  const seriesConfig: SeriesConfig<NlVaccineStockArchived_20211027Value> = [
    {
      type: 'area',
      metricProperty: `${selected}_available` as keyof NlVaccineStockArchived_20211027Value,
    ...
    {
      type: 'line',
      metricProperty: `${selected}_total` as keyof NlVaccineStockArchived_20211027Value,
...
function getMaximumPropertyValueInTimeframe(values: NlVaccineStockArchived_20211027Value[], timeframe: TimeframeOption, today: Date) {
