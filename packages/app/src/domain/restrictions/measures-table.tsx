...
export function MeasuresTable(props: MeasuresTableProps) {
  ...
  if (breakpoints.lg) {
    return <DesktopMeasuresTable data={data} escalationLevel={level} />;
  }

  return <MobileMeasuresTable data={data} escalationLevel={level} />;
}
...
type MeasuresTableData = {
  data: Measures;
  escalationLevel: EscalationLevelType;
};

function MobileMeasuresTable(props: MeasuresTableData) {
...
function DesktopMeasuresTable(props: MeasuresTableData) {
  const { data, escalationLevel } = props;
