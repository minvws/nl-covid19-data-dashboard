...
function getVariantsDataValue(date_end_unix: number) {
  const value: NlVariantsValue = {
    ...
    lambda_percentage: randomNumberFromTo(randomNumberFrom, randomNumberTo),
    lambda_occurrence: randomNumberFromTo(100, 1000),
    lambda_is_variant_of_concern: Math.random() > 0.5,
    other_percentage: 0,
