...
import { BlockEditor, FormField, FormFieldProps, PatchEvent, PortableTextMarker, ValidationMarker } from 'sanity';
...
export const ValidatedRichText = (props: Partial<{ markers: PortableTextMarker[] }>) => {
  const { markers } = props;
