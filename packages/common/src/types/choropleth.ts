...
import type { GmCollection, GmDifference, NlDifference, VrCollection, VrDifference } from './data';
...
export type DifferenceKey = keyof NlDifference | keyof VrDifference | keyof GmDifference;
