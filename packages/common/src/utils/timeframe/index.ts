...
export const TimeframeOptionsList = [TimeframeOption.ALL, TimeframeOption.ONE_WEEK, TimeframeOption.THIRTY_DAYS, TimeframeOption.THREE_MONTHS, TimeframeOption.SIX_MONTHS, TimeframeOption.LAST_YEAR];
