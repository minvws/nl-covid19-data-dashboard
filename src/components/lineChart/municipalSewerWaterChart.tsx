...
import { MunicipalSewerPerInstallationValue } from '~/types/data';
import { TimeframeOption } from '~/utils/timeframe';
import { useMunicipalSewerWaterChartOptions } from './hooks/useMunicipalSewerWaterChartOptions';
...
export type TProps = {
  averageValues: Value[];
  scatterPlotValues: MunicipalSewerPerInstallationValue[] | undefined;
...
export function MunicipalSewerWaterChart(props: TProps) {
  const {
    averageValues,
    scatterPlotValues,
    text,
  ...
  const chartOptions = useMunicipalSewerWaterChartOptions(
    averageValues,
    scatterPlotValues,
    text,
    timeframe,
