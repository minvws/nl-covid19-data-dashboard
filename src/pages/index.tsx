...
const Home: FCWithLayout<INationalHomepageData> = (props) => {
  const { data, siteText, escalationLevelCounts } = props;
  ...
  return (
    <>
      ...
      >
        ...
        >
          <ExternalLink />
          <span>{siteText.notificatie.link.text}</span>
        </a>
      </article>
      ...
      <ChoroplethTile
        title={siteText.positief_geteste_personen.map_titel}
        metadata={{
          date:
            data.infected_people_delta_normalized.last_value
              .date_of_report_unix,
          source: siteText.positief_geteste_personen.bron,
        }}
        description={siteText.positief_geteste_personen.map_toelichting}
...
export async function getStaticProps(): Promise<StaticProps> {
  ...
  return { props: { data, escalationLevelCounts, siteText, lastGenerated } };
}
