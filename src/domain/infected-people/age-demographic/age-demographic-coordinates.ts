...
import { NationalInfectedAgeGroups, NationalInfectedAgeGroupsValue } from "~/types/data";
...
export function getAgeDemographicCoordinates(data: NationalInfectedAgeGroups, isSmallScreen: boolean, parentWidth: number): AgeDemographicCoordinates {
